...
```
Tornadoes are responsible for the most personal harm by a wide margin

```{r}
x <- econ.sums[1:7,]
x$EVTYPE <- factor(x$event.type, levels=x$event.type) # So ggplot doesnt alphabatize x-axis 
